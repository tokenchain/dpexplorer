...
export default class Proposals extends Component{
    ...
    render() {
        return <div>
            <Helmet>
                <title>Governance Proposals on Darkpool Hub | The DP Hub</title>
                <meta name="description" content="Darkpool Hub incorporates on-chain governance. Come to see how on-chain governance can be achieved on The DP Hub." />
            </Helmet>
            <Row>
