    ...
    render () {
        if (this.props.loading) {
            ...
            if (this.props.blockExist) {
                ...
                return <Container id="block">
                    <Helmet>
                        <title>Block {numbro (block.height).format ("0,0")} on Darkpool Hub | The DP Hub</title>
                        <meta name="description"
                              content={"Block details of height " + numbro (block.height).format ("0,0")}/>
                    </Helmet>
                        ...
                        <CardBody>
                            <Row>
                                ...
                                <Col md={8} className="value"><TimeStamp
                                    time={block.time}/> ({moment (block.time).fromNow ()})</Col>
                            </Row>
                        </CardBody>
                    </Card>
                    <TranactionTabs
