...
export default TransactionsContainer = withTracker ((props) => {
    ...
    return {
        ...
        bondTxs : transactionsExist ? Transactions.find ({
            $or : [
                { "tx.value.msg.type" : "bonds/Bond" },
                { "tx.value.msg.type" : "bonds/FunctionParam" },
                { "tx.value.msg.type" : "bonds/Batch" },
                { "tx.value.msg.type" : "bonds/BaseOrder" },
                { "tx.value.msg.type" : "bonds/BuyOrder" },
                { "tx.value.msg.type" : "bonds/SellOrder" },
                { "tx.value.msg.type" : "bonds/SwapOrder" },
                { "tx.value.msg.type" : "bonds/MsgCreateBond" },
                { "tx.value.msg.type" : "bonds/MsgEditBond" },
                { "tx.value.msg.type" : "bonds/MsgBuy" },
                { "tx.value.msg.type" : "bonds/MsgSell" },
                { "tx.value.msg.type" : "bonds/MsgSwap" }
            ]
        }).fetch () : {},
